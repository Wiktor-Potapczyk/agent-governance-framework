 ...
 * Source draft: Projects/Agent-Governance-Research/work/2026-06-11-procedure-layer-migration-plan.md Part C §process-analysis.
...
const QUALITY_SCHEMA = {
  ...
  properties: {
    ...
    all_criteria_addressed: { type: 'boolean', description: 'every rubric criterion (evaluation) or aspect of the core question (investigation) is addressed with a clear assessment.' },
...
// Evaluation mode guard: rubric MUST be non-empty (plan Part C: required schema field when mode=evaluation)

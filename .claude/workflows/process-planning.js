/*
 * ADOPTED 2026-06-11 — live procedure-layer workflow (Wiktor GO; Action-0.1 calibration explicitly waived).
 * Source draft: Projects/Agent-Governance-Research/work/2026-06-09-process-planning-workflow-draft.js (review trail there).
...
// Wiktor carrying BOTH verdicts instead of silently converging
...
while (true) {
  ...
  if (divergence.diverge) {
    log(`ESCALATION: dual-judge divergence: architect=${architectVerdict.verdict} (side=${divergence.architect_side}) vs adversarial=${adversarialVerdict.verdict} (side=${divergence.adversarial_side}). Surfacing BOTH verdicts to Wiktor; NOT converging (feedback_surface_divergent_verdicts_dont_collapse).`)
    return {

...
def main() -> int:
    # RETIRED 2026-08-07 by Wiktor's ruling in chat: "let's just remove that guard,
    # it's nonsense anyways." Neutered first because the guard blocks the very
    # settings edit that deregisters it. Deregistration + move to retired/ follow.
    return 0
    try:

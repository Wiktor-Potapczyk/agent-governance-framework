...
# record of the subagent's own transcript (verified on live run dirs, plan
# Step 2), so a bounded head read recovers the identity -- the symmetric
# operation to the tail read above. The run id is the path component after

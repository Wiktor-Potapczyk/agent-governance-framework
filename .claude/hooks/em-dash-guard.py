...
def main():
    ...
    try:
        ...
        return 0
    # Valid JSON of the wrong shape is still unusable input. Without this, a bare
    # array or scalar reached `.get` and printed an AttributeError traceback into
    # the transcript. See test_hooks_survive_malformed_payload.py.

...
HOOK_PATH = r"C:\Users\WiktorPotapczyk\Desktop\Vault\.claude\hooks\some-hook.py"
...
class PathFilterTests(unittest.TestCase):
    def test_hook_py_is_gated(self):
        ...
        self.assertTrue(gate.is_gated_hook_write(
            "C:/Users/WiktorPotapczyk/Desktop/Vault/.claude/hooks/test_foo.py"
        ))  # test_*.py INCLUDED by design (plan Step-2 decision)

    def test_non_py_ignored(self):
        self.assertFalse(gate.is_gated_hook_write(
            r"C:\Users\WiktorPotapczyk\Desktop\Vault\.claude\hooks\notes.md"
        ))

    def test_outside_hooks_ignored(self):
        self.assertFalse(gate.is_gated_hook_write(
            r"C:\Users\WiktorPotapczyk\Desktop\Vault\.claude\scripts\foo.py"
        ))
        self.assertFalse(gate.is_gated_hook_write(
            r"C:\Users\WiktorPotapczyk\Desktop\Vault\Projects\X\work\foo.py"
        ))

    def test_excluded_subdirs_ignored(self):
        for sub in ("_state", "archive", "aggregates", "__pycache__"):
            self.assertFalse(gate.is_gated_hook_write(
                rf"C:\Users\WiktorPotapczyk\Desktop\Vault\.claude\hooks\{sub}\foo.py"
            ), sub)
...
class GateBehaviorTests(unittest.TestCase):
    ...
    def test_outside_hooks_runs_no_pytest(self):
        ...
        with mock.patch.object(
            ...
            rc, out = _run(
                _payload(r"C:\Users\WiktorPotapczyk\Desktop\Vault\Notes\x.py"), {}
            )
        self.assertEqual(rc, 0)
    ...
    def test_state_write_ignored(self):
        ...
        with mock.patch.object(
            ...
            rc, out = _run(_payload(
                r"C:\Users\WiktorPotapczyk\Desktop\Vault\.claude\hooks\_state\x.py"
            ), {})
        self.assertEqual(rc, 0)
        self.assertEqual(out, "")
        self.assertEqual(calls, [])

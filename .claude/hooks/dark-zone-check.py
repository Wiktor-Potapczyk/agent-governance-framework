...
def main():
    ...
    # R17 tune (owner 'ok go' 2026-09-06, sampling 2026-09-06-mine-sig-sampling):
    # only the worst-case shape emits. Spread-sampled events were ~70 percent
    # routine turns already self-classified adequate; low/medium severities are
    # still computed for the in-process warning below, they just no longer land

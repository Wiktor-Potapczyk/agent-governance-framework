...
def main():
    ...
    # Valid JSON of the wrong shape is still unusable input. This hook's own
    # docstring promises exit 0 always; a bare array reached .get and raised
    # instead. See test_hooks_survive_malformed_payload.py.

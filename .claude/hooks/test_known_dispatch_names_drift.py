...
Projects/Agent-Governance-Research/scripts/shared/known_names.py (the old
...
class TestKnownDispatchNamesDrift(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # 2026-09-21: the loader adds Claude Code's built-in agent types (Explore,
        # general-purpose, Plan, web-fetch, fork, claude) that no registry lists.
        from _known_dispatch_names_loader import BUILTIN_AGENT_TYPES
        cls.generated = set(cls.generated) | set(BUILTIN_AGENT_TYPES)

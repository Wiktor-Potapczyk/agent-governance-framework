---
component: "SubagentStop[0.0]@security-guidance@claude-plugins-official"
kind: "hook"
source_inventory_generated_at: "2026-09-15T09:07:05Z"
---

# hook: SubagentStop[0.0]@security-guidance@claude-plugins-official
...
UNFILLED-HOW (see tier policy in README.md; plugin-internal mechanism, upstream source at `C:/Users/WiktorPotapczyk/.claude/plugins/cache/claude-plugins-official/security-guidance/2.0.8/hooks/sg-python.sh`)
<!-- PROSE:END -->

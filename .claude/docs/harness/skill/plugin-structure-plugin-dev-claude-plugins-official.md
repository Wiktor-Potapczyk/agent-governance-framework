---
component: "plugin-structure@plugin-dev@claude-plugins-official"
kind: "skill"
source_inventory_generated_at: "2026-09-15T09:07:05Z"
---

# skill: plugin-structure@plugin-dev@claude-plugins-official

<!-- GENERATED:BEGIN owned by docs_stub_generate.py; regeneration rewrites this block -->
- **Path:** `C:/Users/WiktorPotapczyk/.claude/plugins/cache/claude-plugins-official/plugin-dev/ad67e9da6bc2/skills/plugin-structure`
- **Provenance:** plugin:claude-plugins-official/plugin-dev
- **Reachability:** `EVD-004` (.claude/registry.json), `EVD-006` (C:/Users/WiktorPotapczyk/.claude/plugins/cache/claude-plugins-official/plugin-dev/ad67e9da6bc2/skills/plugin-structure/SKILL.md)
...
UNFILLED-HOW (see tier policy in README.md; plugin-internal mechanism, upstream source at `C:/Users/WiktorPotapczyk/.claude/plugins/cache/claude-plugins-official/plugin-dev/0120fb83da5d/skills/plugin-structure`)
<!-- PROSE:END -->

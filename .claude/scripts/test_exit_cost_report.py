...
GOVERNANCE_LOG_PATH / HOOK_ACTIVITY_LOG_PATH overrides. The live
settings.local.json supplies the Stop-chain set; fixtures only use hooks
that are stably registered there (classifier-field-check,
dispatch-compliance-check, work-verification-check, governance-log).
"""
import json
import os
import subprocess

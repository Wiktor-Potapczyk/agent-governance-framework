...
> **Layout change (2026-09-23).** The framework now ships as the generated bare vault: the harness lives under `.claude/`. The reproducible sequence for a fresh machine is `Resources/setup-recreation-runbook.md`; the steps below describe the previous curated layout and are kept until they are rewritten.

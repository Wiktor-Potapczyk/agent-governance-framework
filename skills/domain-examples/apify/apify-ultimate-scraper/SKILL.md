...
description: "General-purpose Apify web scraper for platforms not covered by specialized Apify skills, or when scraping raw data without a specific analysis goal. Use as a fallback when no specialized apify-* skill matches the task. For specific goals (leads, trends, competitors, influencers, audience, content analytics, market research), prefer the dedicated apify-* skill."
---
